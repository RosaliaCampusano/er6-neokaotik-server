...
var auth_1 = __importDefault(require("firebase-admin/auth"));
var verifyToken = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var idToken, decodedToken, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, auth_1.default.getAuth().verifyIdToken(idToken)];
            case 2:
            ...
            case 3:
                err_1 = _a.sent();
                console.log("FAILED ", err_1 === null || err_1 === void 0 ? void 0 : err_1.message);
                res.status(401).send({
                    status: "FAILED",
                    data: {
                        error: err_1.message,
